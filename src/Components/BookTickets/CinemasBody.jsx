        ...
        <div className={styles.container} >
            ...
            >
                <div className={styles.modalText}>
                    ...
                    <p>8. Guest Agrees to be contacted by IMAX Management for the purpose of seeking feedback for service improvement.</p>
                    <p>9. Decision(s) taken by IMAX shall be final and binding, Rights of admission reserved.</p>
